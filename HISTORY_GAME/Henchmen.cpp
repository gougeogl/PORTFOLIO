/*****************************************************************************
 * File Name: Henchmen.cpp
 * Programmer: Glen Gougeon
 * Last-Mod: 9-4-20
 * Game Title: A Nap in Time, A History Major's Unexpected Journey

 * Description:		Definition for Henchmen SUB Class :
...
// NO initiative
int Henchmen::rollInitiative() { return 0; }
 ...
 * *****************************************************************/
int Henchmen::attack(Character *enemy)
{
